...
export const DEMO_PRICING_DATA: DemoPriceItem[] = [
  ...
  // CONDUIT
  { category: 'Conduit', description: 'EMT, 1/2"', unit: 'FT', materialCost: 0.42, vendor: 'Demo' },
  { category: 'Conduit', description: 'EMT, 3/4"', unit: 'FT', materialCost: 0.58, vendor: 'Demo' },
  { category: 'Conduit', description: 'EMT, 1"', unit: 'FT', materialCost: 0.85, vendor: 'Demo' },
  { category: 'Conduit', description: 'EMT, 1-1/4"', unit: 'FT', materialCost: 1.25, vendor: 'Demo' },
  { category: 'Conduit', description: 'EMT, 1-1/2"', unit: 'FT', materialCost: 1.65, vendor: 'Demo' },
  { category: 'Conduit', description: 'EMT, 2"', unit: 'FT', materialCost: 2.25, vendor: 'Demo' },
  { category: 'Conduit', description: 'PVC, 1/2"', unit: 'FT', materialCost: 0.35, vendor: 'Demo' },
  { category: 'Conduit', description: 'PVC, 3/4"', unit: 'FT', materialCost: 0.48, vendor: 'Demo' },
  { category: 'Conduit', description: 'PVC, 1"', unit: 'FT', materialCost: 0.68, vendor: 'Demo' },

  // WIRE & CABLE
  { category: 'Wire', description: '#14 THHN CU', unit: 'FT', materialCost: 0.28, vendor: 'Demo' },
  { category: 'Wire', description: '#12 THHN CU', unit: 'FT', materialCost: 0.35, vendor: 'Demo' },
  { category: 'Wire', description: '#10 THHN CU', unit: 'FT', materialCost: 0.58, vendor: 'Demo' },
  { category: 'Wire', description: '#8 THHN CU', unit: 'FT', materialCost: 0.95, vendor: 'Demo' },
  { category: 'Wire', description: '#6 THHN CU', unit: 'FT', materialCost: 1.45, vendor: 'Demo' },
  { category: 'Wire', description: '#4 THHN CU', unit: 'FT', materialCost: 2.25, vendor: 'Demo' },
  { category: 'Wire', description: '#2 THHN CU', unit: 'FT', materialCost: 3.50, vendor: 'Demo' },
  { category: 'Wire', description: '#1 THHN CU', unit: 'FT', materialCost: 4.75, vendor: 'Demo' },
